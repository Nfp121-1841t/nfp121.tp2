...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        assertEquals("    10 °F -> -12.3 °C ? ", -12.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(10), 0.1);
        assertEquals("  80 °F -> 26.6 °C ? ", 26.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(80), 0.1);
        assertEquals(" 1000 °F -> 537.7 °C ?", 537.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(1000), 0.1);
    ...
    public void testing()
    {
        assertEquals(26.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(80), 0.1);
    }
}
